...
uSql = " UPDATE [dbo].[tblQRClick] SET [super] = [super] + 1 WHERE CLICK_DATE = CONVERT(CHAR(10), CURRENT_TIMESTAMP, 23) "
.ExecuteSql uSql, "text"

End With
Set db = Nothing

response.redirect ("http://m.purecotton.co.kr/promise/purecotton_super.asp")
%>
</body>
</html>