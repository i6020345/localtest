...
uSql = " UPDATE [dbo].[tblQRClick] SET [slim] = [slim] + 1 WHERE CLICK_DATE = CONVERT(CHAR(10), CURRENT_TIMESTAMP, 23) "
.ExecuteSql uSql, "text"

End With
Set db = Nothing

response.redirect ("http://m.purecotton.co.kr/promise/purecotton_slim.asp")
%>
</body>
</html>